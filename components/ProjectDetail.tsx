        ...
        <div className="min-h-screen pt-20 sm:pt-24 md:pt-32 px-4 sm:px-6 md:px-12 lg:px-20 pb-12 sm:pb-16 md:pb-20 animate-fade-in relative z-20">
            ...
            <div className="mb-8 sm:mb-12">
                <div className="flex flex-wrap gap-2 sm:gap-4 mb-3 sm:mb-4">
                    {project.tags.map((tag, i) => (
                        <span key={i} className="text-[9px] sm:text-[10px] uppercase tracking-widest border border-gray-800 px-2 py-1 text-gray-500">
                            {tag}
                        </span>
                    ))}
                </div>
                ...
                <p className="text-base sm:text-lg md:text-xl text-gray-400 max-w-2xl leading-relaxed">{project.description}</p>
            </div>
            ...
            <div className="w-full aspect-video bg-[#111] border border-gray-800 mb-8 sm:mb-12 flex flex-col items-center justify-center group relative overflow-hidden">
                ...
                {project.youtubeVideoId ? (
                    ...
                    <div className="text-center z-10">
                        ...
                        <p className="text-gray-500 font-mono text-xs sm:text-sm tracking-widest">VIDEO PREVIEW COMING SOON</p>
                    </div>
                )}
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 sm:gap-12 md:gap-16">
                <div className="lg:col-span-2 space-y-10 sm:space-y-12 md:space-y-16">
                    <section>
                        <h3 className="text-xl sm:text-2xl font-bold display-font mb-4 sm:mb-6 text-white border-l-4 border-white pl-3 sm:pl-4">ABOUT THE PROJECT</h3>
                    ...
                    <section>
                        <h3 className="text-xl sm:text-2xl font-bold display-font mb-4 sm:mb-6 text-white border-l-4 border-gray-700 pl-3 sm:pl-4">THE JOURNEY</h3>
                        <p className="text-gray-400 leading-relaxed text-sm sm:text-base md:text-lg">
                    ...
                    <section>
                        <h3 className="text-xl sm:text-2xl font-bold display-font mb-4 sm:mb-6 text-white border-l-4 border-gray-700 pl-3 sm:pl-4">CONTRIBUTIONS</h3>
                        <p className="text-gray-400 leading-relaxed text-sm sm:text-base md:text-lg">
                ...
                <div className="lg:col-span-1">
                    <div className="bg-white/5 p-6 sm:p-8 border border-white/10 sticky top-20 sm:top-24 md:top-32">
                        <h4 className="font-bold text-white mb-4 sm:mb-6 tracking-widest text-[10px] sm:text-xs uppercase">Project Details</h4>
                        
                        <div className="space-y-4 sm:space-y-6">
                            <div>
                                <p className="text-gray-500 text-[10px] sm:text-xs mb-1">YEAR</p>
                                <p className="text-white font-mono text-sm sm:text-base">{project.year || "2023"}</p>
                            </div>
                            <div>
                                <p className="text-gray-500 text-[10px] sm:text-xs mb-1">ROLE</p>
                                <p className="text-white font-mono text-sm sm:text-base">{project.role || "Developer"}</p>
                            </div>
                            <div>
                                <p className="text-gray-500 text-[10px] sm:text-xs mb-1">CATEGORY</p>
                                <p className="text-white font-mono text-sm sm:text-base uppercase">{project.category}</p>
                            </div>
                        </div>
                    </div>
                </div>
